	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedStruct: Settings{
				...
				QueueHealthCheckInterval:             0,
				QueueHealthStuckThreshold:            180,
			},
		},
		{
			...
			configMap: map[string]string{
				...
				"queue-health-check-interval":             "300",
				"queue-health-stuck-threshold":            "300",
			},
			expectedStruct: Settings{
				...
				RememberOKToTest:                    false,
				SkipPushEventForPRCommits:           true,
				QueueHealthCheckInterval:            300,
				QueueHealthStuckThreshold:           300,
			},
		},
		{
		...
		{
			name: "test disabling queue health checker",
			configMap: map[string]string{
				"queue-health-check-interval":  "0",
				"queue-health-stuck-threshold": "0",
			},
			expectedStruct: Settings{
				ApplicationName:                      "Pipelines as Code CI",
				HubCatalogs:                          nil,
