...
func (t *tektonHubClient) GetResource(ctx context.Context, catalogName, resource, kind string) (string, error) {
	var rawURL string
	var err error

	if strings.Contains(resource, ":") {
		rawURL, err = t.getSpecificVersion(ctx, catalogName, resource, kind)
	} else {
		rawURL, err = t.getLatestVersion(ctx, catalogName, resource, kind)
	}
	if err != nil {
