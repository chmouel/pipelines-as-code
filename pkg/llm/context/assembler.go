...
func (a *Assembler) BuildContext(
	...
	if contextConfig.ErrorContent {
		if errorData, err := a.buildErrorContent(ctx, pipelineRun); err != nil {
			a.logger.Warnf("Failed to build error content: %v", err)
		} else if errorData != nil {
	...
	if contextConfig.ContainerLogs != nil && contextConfig.ContainerLogs.Enabled {
		...
		if logData, err := a.buildContainerLogs(ctx, pipelineRun, maxLines); err != nil {
			a.logger.Warnf("Failed to build container logs: %v", err)
		} else if logData != nil {
...
func (a *Assembler) buildBasicPipelineContext(pipelineRun *tektonv1.PipelineRun, event *info.Event) map[string]interface{} {
...
func (a *Assembler) buildCommitContent(ctx context.Context, event *info.Event, provider provider.Interface) (map[string]interface{}, error) {
	if event == nil {
...
func (a *Assembler) buildPRContent(ctx context.Context, event *info.Event, provider provider.Interface) (map[string]interface{}, error) {
...
func (a *Assembler) buildErrorContent(ctx context.Context, pipelineRun *tektonv1.PipelineRun) (map[string]interface{}, error) {
...
func (a *Assembler) buildContainerLogs(ctx context.Context, pipelineRun *tektonv1.PipelineRun, maxLines int) (map[string]interface{}, error) {
...
func (a *Assembler) BuildCELContext(
	...
	if event != nil {
		...
		celData["body"].(map[string]interface{})["event"] = eventMap
	}
...
func (a *Assembler) pipelineRunToMap(pr *tektonv1.PipelineRun) (map[string]interface{}, error) {
...
func (a *Assembler) repositoryToMap(repo *v1alpha1.Repository) (map[string]interface{}, error) {
	// Marshal to JSON and back to get a clean map representation
