...
func (h *HealthChecker) CheckHealth(ctx context.Context, client Client) *HealthCheckResult {
	startTime := time.Now()
...
func (h *HealthChecker) ValidateProviderConfig(provider LLMProvider, config map[string]interface{}) error {
	switch provider {
...
func (h *HealthChecker) CheckProviderAvailability(ctx context.Context, provider LLMProvider, baseURL string) error {
