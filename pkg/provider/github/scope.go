...
func ScopeTokenToListOfRepos(ctx context.Context, vcx provider.Interface, repo *v1alpha1.Repository, run *params.Run, event *info.Event, eventEmitter *events.EventEmitter, logger *zap.SugaredLogger) (string, error) {
	var (
		listRepos bool
		token     string
	)
